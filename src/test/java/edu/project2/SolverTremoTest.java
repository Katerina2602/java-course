...
class SolverTremoTest {
    private final Solver solver = new SolverTremo();
    ...
    void willFindCorrectPath() {
        ...
        renderer.render(maze, actualCoordinates);
    ...
    void test() {
        ...
        Coordinate start = new Coordinate(0, 0);
        Coordinate end = new Coordinate(20, 30);
        Solver list = new SolverTremo();

        renderer.render(maze, list.solve(maze, start, end));
    }
