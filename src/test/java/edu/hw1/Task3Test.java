...
class Task3Test {
    @Test
    void willReturnTrueWhenArrayNestable() {
    ...
    @Test
    void willReturnFalseWhenArrayIsNotNestable() {
    ...
    @Test
    void willReturnFalseWhenArrayIsNotNestable111() {
        assertThrows(IllegalArgumentException.class, () -> Task3.isNestable(new int[] {9, 9, 8}, new int[] {}));
